...
<div class="flex flex-wrap gap-2 font-mono text-xs mb-6 bg-slate-900/50 p-3 rounded-lg border border-gray-800">
    <span class="text-gray-500">SEVERIDAD: <strong class="text-amber-500">MEDIA</strong></span>
    <span class="text-gray-600">|</span>
    <span class="text-gray-500">ESTADO: <strong class="text-emerald-500">ANONIMIZADO</strong></span>
    <span class="text-gray-600">|</span>
    <span class="text-gray-500">TIPO: <strong class="text-accent">OSINT</strong></span>
</div>

<article class="bg-darkCard p-8 rounded-2xl border border-gray-700 shadow-2xl">
    <div class="prose prose-invert prose-blue max-w-none" markdown="1">
